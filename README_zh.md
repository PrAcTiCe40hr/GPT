...
话题 | 内容 | 家庭作业/讨论
:-- | :--: | :--: |
简介 | 第1讲：人工智能 (AI) 和深度学习 (DL) 简介<br>第2讲：自然语言处理 (NLP) 和不同公司的大型语言模型 (LLM) 简介[Bard (谷歌), LLaMA (Meta) \& Ernie (百度)] | - Python 项目：设置 GitHub 页面并创建一个 hello-world 存储库<br> - 报告项目：在 AGI（通用人工智能）上进行一次调查
